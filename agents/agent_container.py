...
class AgentContainer:
    def __init__(self, user_id: str, db_manager):
        ...
        self.image_processing_agent = Agent(
            ...
            instructions="""Вы являетесь специалистом по обработке медицинских изображений. Ваша роль состоит в следующем:
1. Анализировать изображения, связанные с медициной (рецепты, результаты анализов, видимые симптомы и т.д.)
2. Предоставлять детализированные, структурированные описания того, что вы видите
3. Сосредотачиваться на медицински значимых деталях
4. Форматировать результаты в четкой и организованной форме
5. Выделять любые вызывающие беспокойство или примечательные медицинские находки""",
