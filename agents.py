...
""",
        model="openai/gpt-4o",
        functions=[]  # This agent doesn't need special functions
    )
...
ВАЖНО: Если ты получил "Анализ изображения от пользователя" с релевантными медицинскими данными то запиши их с помощью: append_patient_data, replace_patient_data
