...
- Если ты получил интерпретацию изображений с релевантными медицинскими данными, то запиши их с помощью update_medical_record.
...
Не оставляй своих комментариев насчет медицины, твои интерпретации попадут на стол настоящему врачу
"""
